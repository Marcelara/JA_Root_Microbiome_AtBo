...
lm <- as.data.frame(lm)
write.table(lm, "clipboard", sep = "\t", row.names = TRUE) #then copy directly in excel 
...
# Function to extract a cleaned ANOVA table from each element
...
# split the Sample column into Plant_species and Compartment
