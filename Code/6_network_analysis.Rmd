...
#Individual results
Nodes_AT_root <- read_csv("./R output/Network files/Nodes_AT_root.csv")
Nodes_BO_root <- read_csv("./R output/Network files/Nodes_BO_root.csv")
Nodes_AT_soil <- read_csv("./R output/Network files/Nodes_AT_soil.csv")
Nodes_BO_soil <- read_csv("./R output/Network files/Nodes_BO_soil.csv")

#network metrics (Summary)
network_metrics <- read_csv("./R output/Network files/netwrok_metrics.csv")
...
# 6.9 -  overwrite saved session [MA: SKIP]
```{r}
